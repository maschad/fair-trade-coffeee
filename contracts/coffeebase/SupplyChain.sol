...
contract SupplyChain {
    ...
    modifier verifyCaller(address _address) {
        require(msg.sender == _address, "Only sender can call this function");
        _;
    }
    ...
    modifier sold(uint256 _upc) {
        require(items[_upc].itemState == State.Sold, "Item should be sold.");
        _;
    }
